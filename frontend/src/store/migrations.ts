...
/**
 * V4 migration placeholder (previously applied EE settings defaults).
 * Kept as no-op to preserve migration version numbering.
 */
function applyEESettingsDefaultsV4(): void {
  // No-op: EE settings defaults no longer needed
}
